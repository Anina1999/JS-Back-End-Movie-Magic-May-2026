...
export const createMovieSchema = z.object({
    ...
    // born: z.coerce.number()
    //     .min(10, { message: "Born place must be at least 10 characters long" })
    //     .regex(/^[A-Za-z0-9 ]+$/, { message: "Born place can only contain letters, numbers, and spaces" }),
});